...
public class Show_json extends AppCompatActivity {
    ...
    String save_data="your answers are here:\n \n";  //User's answer
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txt_answer = (TextView)findViewById(R.id.txt_answers);

        //Read file
        try {
            String show_json;
            String PATH=getExternalFilesDir(null)+"/question.json";
    ...
    public void choose(View view){
        if(question[flag]!=null) {
            ...
            if(question[flag]== null){
                bt_choose.setText("save answers");
            }
        }else{
            Toast.makeText(Show_json.this,"Your answers have been saved",Toast.LENGTH_SHORT).show();
            save_answer(save_data);
        }
    }

    public void show(View view){
        txt_answer.setText(save_data);
    }
